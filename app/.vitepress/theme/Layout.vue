...
<footer class="text-center text-gray-400 text-sm mb-5">
  <div class="text-center mb-3">
    <a href="https://github.com/loonpwn" target="_blank" class="unstyled transition-opacity inline-block opacity-70 hover:opacity-100 mr-3" title="Github: Loonpwn">
  ...
  <p>© 2020 Harlan Wilton, All rights reserved. Created using <a href="https://vitepress.vuejs.org/" target="_blank">VitePress</a></p>
</footer>
<Debug />
</template>
